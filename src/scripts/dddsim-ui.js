...
function init() {
  ...
  HTML.textboxSprite = HTML.textbox?.querySelector('.dddsim-talkbox')
  ...
  characters.forEach(char => {
    ...
    if (cName === speaking) {
      ...
      if (getPlayerSetting('animation')) {
        ...
        character.classList.add('dddsim-animated-sprite')
      }
    }
...
function loadDialogueText(dialogue) {
  ...
  if (speaker == "Narrator") {
    HTML.text.classList.add("dddsim-narrator-font")
  }
  else {
    HTML.text.classList.remove("dddsim-narrator-font")
  }
...
function writeLog
  ...
  line.classList.add('dddsim-log-entry')
  if (!dialogue) line.classList.add('dddsim-log-entry-action')
